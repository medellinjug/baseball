...
public class playerServiceBean {
    ...
    private List<Player>sortedPlayerss(List<Player> playList) {
        return playList.stream().sorted(Comparator.comparing(Player::getType).thenComparing(Player::getFullName)).collect(Collectors.toList());
    }
